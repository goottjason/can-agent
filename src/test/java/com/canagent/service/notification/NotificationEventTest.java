...
class NotificationEventTest {
    ...
    void fromTrade_buyTrade_createsEvent() {
        ...
        Trade trade = new Trade(stock, TradeType.BUY, new BigDecimal("10"), new BigDecimal("70000"), "테스트 매수");
        ...
        assertThat(event.quantity()).isEqualByComparingTo(new BigDecimal("10"));
    ...
    void fromTrade_sellTrade_createsEvent() {
        Stock stock = MockDataFactory.createSamsungStock();
        Trade trade = new Trade(stock, TradeType.SELL, new BigDecimal("10"), new BigDecimal("80000"), "익절");
